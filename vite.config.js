  ...
  return {
    ...
    transform(code, id) {
      ...
      if (id.endsWith("/src/App.jsx")) {
        ...
        const catchReplacement = `const billingErr = result?.error || {};\n        const diagnostics =\n          (typeof window !== "undefined" && window.__fiftyFitBillingDiagnostics) || {};\n        const resolvedBillingCode =\n          __fiftyFitExtractBillingCodeV5(billingErr) ??\n          __fiftyFitExtractBillingCodeV5(diagnostics);\n        const rawOperationCode =\n          billingErr.operationCode || billingErr.code || diagnostics.operationCode || diagnostics.code || null;\n        const fallbackOperationCode =\n          rawOperationCode && rawOperationCode !== "billing_flow_failed"\n            ? rawOperationCode\n            : "NATIVE_RESPONSE_CODE_NOT_RETURNED";\n        const billingCode = String(\n          resolvedBillingCode != null\n            ? resolvedBillingCode\n            : (result?.pending ? "purchase_pending" : fallbackOperationCode)\n        );`;
        ...
        const errorCatchReplacement = `const diagnostics =\n        (typeof window !== "undefined" && window.__fiftyFitBillingDiagnostics) || {};\n      const resolvedBillingCode =\n        __fiftyFitExtractBillingCodeV5(e) ??\n        __fiftyFitExtractBillingCodeV5(diagnostics);\n      const rawOperationCode =\n        e?.operationCode || e?.code || diagnostics.operationCode || diagnostics.code || null;\n      const fallbackOperationCode =\n        rawOperationCode && rawOperationCode !== "billing_flow_failed"\n          ? rawOperationCode\n          : "NATIVE_RESPONSE_CODE_NOT_RETURNED";\n      const billingCode = String(\n        resolvedBillingCode != null ? resolvedBillingCode : fallbackOperationCode\n      );`;
