...
# Native plugin 8.1.0 historically returns only the first subscription offer to JS.
# Export every eligible offer and honor the offerToken selected by the web layer.
