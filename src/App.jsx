...
async function signInWithGoogleFlow(localLang) {
  // Step 1: Show native Google account picker (no WebView, uses the system account)
  ...
  // Step 3: Create a Firestore doc for brand-new Google sign-in users
  ...
  return (
    ...
    >
      ...
      {resetSent && (
        ...
        >
          {ar
            ? "شوف إيميلك هيوصلك رابط لإعادة تعيين كلمة السر."
            ...
            return (
              ...
              >
                ...
                >
                  {(() => {
                    const dt = new Date();
                    dt.setDate(dt.getDate() - todayIdx + i);
                    return dt.getDate();
                  })()}
                </span>
                {isDone && (
          ...
          return (
            ...
            >
              ...
              >
                <div
                  onClick={() =>
                    go("exercise", { exerciseId: ex.id, day: selectedDay })
                  }
                  style={{
                    display: "flex",
                    alignItems: "center",
